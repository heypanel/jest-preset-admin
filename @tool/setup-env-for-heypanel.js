...
if (!srcPath) {
    throw new Error('"globals.adminPath" is not defined. A file path to a HeyPanel 6 administration is required');
}

global.window._features_ = {};

const HeyPanel = require(resolve(join(srcPath, `src/core/heypanel.ts`))).HeyPanelInstance;
